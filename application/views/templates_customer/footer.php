                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <p>MERTASARI RENT CAR adalah Pintu penghubung antara penyedia rental dengan customer. Sebuah marketplace untuk penyedia rental dan customer untuk saling terhubung.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            <h2>Hubungi Kami</h2>
                            <div class="widget-body">
                                <p>Hubungi kami untuk mengetahui lebih banyak. Dapatkan layanan terbaik dan prioritas dari kami, MERTASARI RENT CAR.</p>

                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i>Jl. Raya Kubu Anyar no 99x, Kuta-Bali</li>
                                    <li><i class="fa fa-mobile"></i> +62-8579-2863-319</li>
                                    <li><i class="fa fa-envelope"></i> rentalmertasari@gmail.com</li>
                                </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        COPYRIGHT &copy;<script>document.write(new Date().getFullYear());</script> COMPANY NAME | TEMPLATE BY:<a href="https://colorlib.com" target="_blank">MERTASARI RENT CAR  </a>
